...
- **Progressive Shippers Cooperative** (Janesville) leads with **1,069 sales**.
- **Race Car Help** (Austin) follows closely with **1,019 sales**.
- **Star Enterprises Inc** (Pasco) and **Saab-Belle Dodge** (Aurora) each recorded **1,009 sales**.
- Other high-performing dealers include:
  - **Ryder Truck Rental and Leasing** (Middletown) – **1,008 sales**
  - **U-Haul CO** (Austin) – **1,008 sales**
...
*A screenshot of the table inserted here to visually support the dealer sales comparison.*
...
Below is a screenshot Moving Average of Daily Sales chart generated from the query results:
...
## Gender-Based Sales Over Time

This table provides a summary of car sales by gender across different years, offering insight into demographic-based purchasing behavior.

### Key Observations:

- In 2022:
  - Male buyers accounted for 8,512 sales.
  - Female buyers accounted for 2,133 sales.

- In 2023:
  - Male buyers accounted for 10,286 sales.
  - Female buyers accounted for 2,975 sales.

### Insights:
- Male buyers consistently purchased more vehicles than female buyers in both years.
- Sales increased for both genders from 2022 to 2023.
- The data indicates a continued trend of higher car purchases among males, alongside overall market growth.

This gender-based segmentation helps in understanding customer behavior over time and can guide strategic decisions in marketing and product targeting.

 **Visualization:**
 ![Screenshot 2025-06-10 191200](https://github.com/user-attachments/assets/fecd1b91-8434-499c-898f-e3cfd0855890)
 
 ##  Best-Selling Car Models by Revenue

This section presents a **waterfall chart** that displays total revenue generated by various car models, ordered from highest to lowest.

### Key Observations:

- The chart reveals a **long tail distribution**, where a few models dominate in revenue generation, while many others contribute much smaller amounts.
- Top revenue-generating models such as **'LS400'**, **'Ram Pickup'**, **'Diablo'**, and **'Malibu'** appear at the far left of the chart, clearly outperforming others.
- The tooltip for the **'Villager'** model shows a revenue of **$2,878,703**, offering a concrete data point for a mid-tier performer.
- Revenue drops off significantly for models toward the right of the chart, with models like **'Mirage'** contributing the least.
- This visualization is instrumental in identifying **high-impact car models** and understanding revenue concentration across the product lineup.
![Screenshot 2025-06-10 192106](https://github.com/user-attachments/assets/77f4e9ad-e939-44b0-abc7-e00aa5ee2160)

*A screenshot of the waterfall chart provided here to visually support the revenue distribution analysis.*
